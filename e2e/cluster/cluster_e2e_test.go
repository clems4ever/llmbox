...
// SetNetworkPolicy satisfies the BoxManager verb added for network isolation.
func (m *fakeSpokeMgr) SetNetworkPolicy(context.Context, string, sandbox.NetworkPolicy) error {
	return nil
}
